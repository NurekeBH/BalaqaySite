...
2. https://baura.kz/api/suppliers → `[]` (бос — деректер жоқ)
3. https://baura.kz/ → сайт ашылады, 3 тілді, tab-тар жұмыс істейді
4. Жаңа жеткізуші + тапсырыс қосып көріңіз — деректер DB-да пайда болады
